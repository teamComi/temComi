 ...
 * Generated at: 2023-09-01 04:55:41 UTC
...
public final class party_005fclick_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/party/./view_reply.jsp", Long.valueOf(1693528452618L));
    _jspx_dependants.put("/views/party/../common/footer.jsp", Long.valueOf(1693390968000L));
    _jspx_dependants.put("/views/party/./view_chat.jsp", Long.valueOf(1693476443633L));
 ...
 if(loginMember == null) { 
      ...
      out.write("      var partyMemberType = 'none';\r\n");
      out.write("      ");
 if(loginMember.getMeNum() == member.getMeNum()) { 
      out.write("\r\n");
      out.write("         partyMemberType = 'host';\r\n");
      out.write("      ");
 } else {
      ...
      out.write("\r\n");
      out.write("                  partyMemberType = 'member';\r\n");
      out.write("                  ");
 //break;
               //}
            //}
 ...
 for(int i=0; i<4; i++){ 
      ...
      out.write("            <button id=\"paymentPop\">결제하기</button>\r\n");
      ...
      out.write("            \r\n");
      out.write("            price = 100;\r\n");
      out.write("            var paymentMethodWidget = paymentWidget.renderPaymentMethods(\"#payment-method\", { value: price });\r\n");
      out.write("         \r\n");
      out.write("            $('#payment').click(function(){\r\n");
      out.write("               \r\n");
      out.write("               //결제 금액과 테이블 저장된 금액이 맞을때\r\n");
      out.write("               paymentWidget.requestPayment({\r\n");
      out.write("                  amount: price,\r\n");
      out.write("                  orderId: generateRandomString(),\r\n");
      out.write("                  orderName: ");
      out.print( "\"" + party.getPaTitle() + "\"" );
      out.write(",\r\n");
      out.write("                  //successUrl: sucUrl,\r\n");
      ...
      out.write("                  \r\n");
      out.write("                  console.log('결제가 성공적으로 처리되었습니다.');\r\n");
      out.write("                  console.log('response : ' + response);\r\n");
      out.write("                  \r\n");
      out.write("                  var selectedPaymentMethod = paymentMethodWidget.getSelectedPaymentMethod()\r\n");
      out.write("                  console.log('selectedPaymentMethod : ' + selectedPaymentMethod);\r\n");
      out.write("                  $.ajax({\r\n");
      ...
      out.write("                     ,data : {\r\n");
      out.write("                        \r\n");
      out.write("                        pa_num : Number(");
      out.print( "\"" + party.getPaNum() + "\"" );
      out.write(")\r\n");
      out.write("                        ,me_num : Number(");
      out.print( "\"" + loginMember.getMeNum() + "\"" );
      out.write(")\r\n");
      out.write("                        ,pm_amount : price//결제금액\r\n");
      out.write("                        ,pm_host : depositBool\r\n");
      out.write("                        ,pm_deposit : depositBool\r\n");
      out.write("                        ,pm_method : selectedPaymentMethod.method\r\n");
      out.write("                        \r\n");
      out.write("                     }\r\n");
      out.write("                     ,success : function(result){\r\n");
      out.write("                        console.log('저장완료');\r\n");
      out.write("\r\n");
      ...
      out.write("            \r\n");
      out.write("\r\n");
      out.write("            $('#article-party-share-re').parent().parent().find('.article-party-share-title').text('바꿈');\r\n");
      out.write("\r\n");
      out.write("         })\r\n");
      out.write("         </script>\r\n");
      out.write("         \r\n");
...
if(j == tempList.size()-1) { 
 ...
 if((copage.getCurrentPage() + copage.getLimit()) < copage.getEndPage() 
      ...
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <input type=\"text\" id=\"messageInput\" size=\"110\" placeholder=\"메시지 입력\">\r\n");
      out.write("        <!--채팅 바디end-->\r\n");
      out.write("\r\n");
      out.write("        <!--채팅 입력-->\r\n");
      out.write("        <!-- <div id=\"chat\">\r\n");
      out.write("            <div id=\"messages\"></div>\r\n");
      out.write("            <input type=\"text\" id=\"messageInput\" placeholder=\"메시지 입력\">\r\n");
      out.write("            <button id=\"sendButton\">보내기</button>\r\n");
      out.write("        </div> -->\r\n");
      out.write("        \r\n");
      ...
      out.write("        <button class=\"chating-allow-btn\" id=\"sendButton\">보내기</button>\r\n");
      out.write("    </section>\r\n");
      out.write("    <script>\r\n");
      out.write("        const socket = new WebSocket(\"ws://localhost:8080/comi/comisoket\"); // 웹 소켓 서버 주소와 포트로 연결\r\n");
      ...
      out.write("            let messageStr = JSON.stringify(event.data);\r\n");
      out.write("            const message = JSON.parse(event.data);\r\n");
      out.write("            const messagesDiv = document.getElementById(\"chating_box\");\r\n");
      out.write("            messagesDiv.innerHTML += `<p>` + message.username +` : ` + message.text + `</p>`;\r\n");
      out.write("        };\r\n");
      out.write("\r\n");
      ...
      out.write("            //console.log(messageInput.value);\r\n");
      out.write("            \r\n");
      out.write("            const message = messageInput.value;\r\n");
      out.write("            if (message.trim() !== \"\") {\r\n");
      out.write("                socket.send(JSON.stringify({ username: username, text: message }));\r\n");
